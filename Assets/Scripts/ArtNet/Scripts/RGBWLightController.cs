...
public class RGBWLightController : MonoBehaviour
{
    ...
    [SerializeField] [Range(0.0f, 10.0f)] private float MaxRendererIntensity = 5.0f;
    ...
    private void UpdateRendererByPropatyBlock()
    {
        if (targetRenderer != null)
        {
            ...
            materialPropertyBlock.SetColor(colorPropertyName, _color * rendererIntensity);
            materialPropertyBlock.SetFloat(intensityPropertyName, rendererIntensity);
